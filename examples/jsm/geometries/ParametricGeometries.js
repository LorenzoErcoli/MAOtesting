...
const ParametricGeometries = {
	...
	richmond: function ( v, u, target ) {

			//let randomvalue = Math.floor(Math.random() * 1) + 4;
			...
			x = (-3*u - u*u*u*u*u + 2*(u*u*u)*(v*v) + 3*u*v*v*v*v)/(6*(u*u + v*v))
			y = (-3*v - 3*u*u*u*u*v - 2*u*u*v*v*v + v*v*v*v*v)/(6*(u*u + v*v))
			z = u
		...
		steinbach_screw: function ( v, u, target ) {
	...
	sine_surface: function ( v, u, target ) {
